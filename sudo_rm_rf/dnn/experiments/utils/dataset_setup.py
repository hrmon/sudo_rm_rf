...
from __config__ import (
    WHAM_ROOT_PATH,
    LIBRI2MIX_ROOT_PATH,
    MUSDBWAV8K_ROOT_PATH,
    MUSDBWAV_ROOT_PATH,
    FUSS_ROOT_PATH,
    WHAMR_ROOT_PATH,
    FARSI_WHAM_ROOT_PATH,
    WHAM_NOISE_ROOT_PATH,
)
...
def create_loader_for_simple_dataset(
    ...
    if dataset_name == "WHAM":
        ...
        data_loader = loader.Dataset(
            ...
            noise_dirpath=WHAM_NOISE_ROOT_PATH,
        ...
        import sudo_rm_rf.dnn.dataset_loader.musdb_dataset as musdb_loader
